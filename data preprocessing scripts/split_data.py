...
def split(inFile):
    ...
    f_train_out = open("./training and holdout data (with zscores & interaction attributes)/new_combine_training_data.csv", 'wb')
    f_holdout_out = open("./training and holdout data (with zscores & interaction attributes)/new_combine_holdout_data.csv", 'wb')
